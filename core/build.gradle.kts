...
dependencies {
    ...
    ///api(libs.google.firebase.dynamic.links)
    ...
    ///api(libs.google.firebase.inappmessaging)
    ///api(libs.google.firebase.inappmessaging.display)
    ...
    ///api(libs.google.firebase.ml.modeldownloader)
