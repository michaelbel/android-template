...
package org.michaelbel.template.medium.main.home
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        contentWindowInsets = if (isNavigationRail) WindowInsets(0, 0, 0, 0) else ScaffoldDefaults.contentWindowInsets
    ) { innerPadding ->
        LazyColumn(
            modifier = Modifier
